...
def load_config() -> StrategyOSConfig:
    ...
    return StrategyOSConfig(
        ...
        database_runtime_scope=env("STRATEGYOS_DATABASE_RUNTIME_SCOPE", "request"),
