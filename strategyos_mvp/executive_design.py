...
EXECUTIVE_DESIGN: dict[str, Any] = {
    "personas": {
        ...
        "board": {
            "health": {"score": 86, "headline": "Board endorsed the margin plan and ratified the hedge.", "body": "The GLP-1 JV is approved subject to final supply terms, and the Tamween recovery of SAR 8.6M will be reviewed at Q3. Nothing reaches this room until the Group CEO approves it.", "scoreNote": "board posture"},
            "indexLabel": "The board index",
            "assistant": "Minerva",
            "assistantRole": "board chief of staff",
            "brief": "The board room only sees what the Group CEO has approved: four decks are cleared, one still awaits sign-off, and two decisions are ratified pending final terms.",
            "quote": "Nothing reaches the board until the Group CEO approves it.",
            "by": "Minerva · board chief of staff",
            "threads": [{"key": "hedge_downside", "title": "EUR hedge downside", "preview": "Why is EBITDA 20 bps under plan?"}, {"key": "hedge_risk", "title": "Hedge risk if EUR strengthens", "preview": "Show the hedge downside"}, {"key": "jv_funding", "title": "JV funding from cash", "preview": "Is the JV funded from cash?"}],
            "prompts": ["Why is EBITDA 20 bps under plan?", "Show the hedge downside", "Is the JV funded from cash?"],
            "drivers": [{"key": "revenue", "label": "Revenue", "pct": 102, "value": "SAR 2.09B", "sub": "quarter to date", "vsPlan": "board-approved read", "story": "Revenue is ahead of plan in the version the board has already seen and approved.", "movers": {"lifting": [{"name": "e-Pharmacy", "delta": "+12% orders WoW"}], "dragging": [{"name": "Healthcare Services", "delta": "−3.8% occupancy"}]}}, {"key": "ebitda", "label": "EBITDA margin", "pct": 99, "value": "19.2%", "sub": "vs 19.4% plan", "vsPlan": "hedge ratified", "story": "The board has ratified the 60% EUR hedge to recover most of the margin drag.", "movers": {"lifting": [], "dragging": [{"name": "FX exposure", "delta": "hedge now ratified"}]}}, {"key": "cash", "label": "Cash vs floor", "pct": 123, "value": "SAR 1.48B", "sub": "vs SAR 1.2B floor", "vsPlan": "JV fundable from cash", "story": "Cash headroom supports the approved GLP-1 JV without touching the facility.", "movers": {"lifting": [{"name": "Collections", "delta": "+SAR 145M NUPCO"}], "dragging": []}}, {"key": "localisation", "label": "Vision 2030 localisation", "pct": 104, "value": "38.4% Saudization", "sub": "vs 37% target", "vsPlan": "+1.4 pt vs target", "story": "Localisation is ahead of the Vision 2030 target the board tracks each quarter.", "movers": {"lifting": [{"name": "Saudization hiring", "delta": "ahead of target"}], "dragging": []}}],
            "findings": [{"title": "Board endorsed the margin-protection plan and ratified the hedge", "tag": "Decision · approved", "detail": "The 60% EUR hedge is ratified; most of the FX margin drag is now covered.", "tone": "up"}, {"title": "GLP-1 JV approved subject to final supply terms", "tag": "Decision · approved", "detail": "e-Pharmacy + Capital deck cleared; signature due this week.", "tone": "up"}, {"title": "Tamween recovery & cutover still pending CEO approval", "tag": "Rolled-up · pending", "detail": "SAR 8.6M group recovery will be reviewed again at Q3.", "tone": "flat"}],
            "developments": [{"title": "Margin & the FX hedge decision deck approved", "meta": "Group CFO · Atlas", "impact": "Clears the hedge for execution the moment Treasury confirms.", "kind": "win"}, {"title": "GLP-1 JV supply-lock & funding deck approved", "meta": "e-Pharmacy + Capital", "impact": "Signature can proceed this week from cash.", "kind": "win"}, {"title": "Tamween recovery & cutover deck still pending CEO approval", "meta": "BU CFO · Argus", "impact": "Held back from the room until sign-off; re-reviewed at Q3.", "kind": "watch"}],
            "week": [{"key": "board_meeting", "day": "Thu", "title": "Q2 Board Meeting", "when": "in 3 days", "prep": "Riyadh HQ + remote, 14:00. Four decks approved, one still pending CEO sign-off.", "urgent": True, "prompt": "Why is EBITDA 20 bps under plan?"}, {"key": "hedge_ratify", "day": "on approval", "title": "Ratify the 60% EUR hedge", "when": "pending", "prep": "Group CFO owns execution once ratified.", "urgent": True, "prompt": "Show the hedge downside"}, {"key": "jv_signature", "day": "this week", "title": "Approve GLP-1 JV signature", "when": "this week", "prep": "Group CEO sign-off, funded from cash.", "urgent": False, "prompt": "Is the JV funded from cash?"}],
        },
    },
