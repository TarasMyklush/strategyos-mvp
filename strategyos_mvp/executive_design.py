...
EXECUTIVE_DESIGN: dict[str, Any] = {
    "personas": {
        "ceo": {
            "label": "Group CEO",
            "documentTitle": "Kyvern — Group CEO Briefing",
            "assistant": "Hermes",
        ...
        "cfo": {
            "label": "Group CFO",
            "documentTitle": "Kyvern — Group CFO Briefing",
            "assistant": "Atlas",
        ...
        "gm": {
            "label": "BU GM",
            "documentTitle": "Kyvern — Business Unit Briefing",
            "assistant": "Iris",
        ...
        "bucfo": {
            "label": "BU CFO",
            "documentTitle": "Kyvern — Business Unit Finance Briefing",
            "assistant": "Argus",
        ...
        "logistics": {
            "label": "Logistics",
            "documentTitle": "Kyvern — Logistics Briefing",
            "assistant": "Vega",
        ...
        "board": {
            "label": "Board room",
            "documentTitle": "Kyvern — Board Briefing",
            "assistant": "Minerva",
