  ...
  window.STRATEGYOS_EXECUTIVE_DESIGN = {
    personas: {
        ...
        drivers: [
          {
            ...
            unit: "SAR M per week",
              trend: { actual: [150.8, 151.2, 154.4, 155.5, 157.7, 159.3, 161.6, 165.4, 165.7, 169.2, 170.4, 173.1, 176], plan: [156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168] },
              chips: ["Why is the gap widening?", "Show e-Pharmacy detail", "Risk to full-year plan?"],
              movers: {
                lifting: [
                  { name: "e-Pharmacy", delta: "+12% orders WoW", contribution: 38, gm: { who: "Lina Haddad, GM", note: "Orders +12% WoW on the GLP-1 refill cohort; fulfilment holding at a 2-day SLA. Pushing for the JV signature to lock supply ahead of demand." } },
                  { name: "Pharmacy Retail", delta: "+8.3% like-for-like", contribution: 27, gm: null },
                  { name: "Digital Health", delta: "+36% revenue YoY", contribution: 15, gm: null }
                ],
                dragging: [
                  { name: "Healthcare Services", delta: "−3.8% occupancy", contribution: -18, gm: { who: "Omar Said, GM", note: "Cardiology occupancy −3.8% — two consultants on leave; locum cover lands next week. Plan to recover the gap by quarter-end." } },
                  { name: "Tamween Distribution", delta: "+0.4% — flat vs plan", contribution: -6, gm: { who: "Faisal Noor, GM", note: "Recovering the SAR 1.2M leakage and cutting cost via the S/4HANA cutover; targeting 9.5% margin by year-end." } }
                ]
              }
          },
          {
            ...
            unit: "% margin",
              trend: { actual: [19.54, 19.43, 19.59, 19.44, 19.55, 19.39, 19.48, 19.59, 19.41, 19.5, 19.43, 19.48, 19.2], plan: [19.4, 19.4, 19.4, 19.4, 19.4, 19.4, 19.4, 19.4, 19.4, 19.4, 19.4, 19.4, 19.4] },
              chips: ["What would a 60% EUR hedge save?", "Show the FX bridge", "Which BUs can offset?"],
              movers: {
                lifting: [
                  { name: "Manufacturing", delta: "+60 bps on yield", contribution: 22, gm: null },
                  { name: "Pharmacy Retail", delta: "+30 bps mix", contribution: 12, gm: null }
                ],
                dragging: [
                  { name: "FX exposure", delta: "~SAR 9k / wk drag", contribution: -20, gm: null },
                  { name: "Tamween Distribution", delta: "leakage · SAR 1.2M", contribution: -16, gm: { who: "Faisal Noor, GM", note: "Recovering the SAR 1.2M leakage and cutting cost via the S/4HANA cutover; targeting 9.5% margin by year-end." } },
                  { name: "API input cost", delta: "+4.1% vs plan", contribution: -11, gm: null }
                ]
              }
            },
          {
            ...
            unit: "SAR M per week",
              trend: { actual: [128.32, 128.32, 129.63, 128.69, 129.98, 128.8, 129.67, 130.6, 129.53, 130.55, 130.3, 130.92, 131], plan: [128, 128.17, 128.33, 128.5, 128.67, 128.83, 129, 129.17, 129.33, 129.5, 129.67, 129.83, 130] },
              chips: ["Where is cost running hot?", "Cutover savings timeline", "Compare to last quarter"],
              movers: {
                lifting: [{ name: "Shared services", delta: "−2.0% vs plan", contribution: 14, gm: null }],
                dragging: [
                  { name: "API input cost", delta: "+4.1% vs plan", contribution: -18, gm: null },
                  { name: "Logistics fuel", delta: "+2.6% vs plan", contribution: -9, gm: null }
                ]
              }
            },
          {
            ...
            unit: "SAR B",
              trend: { actual: [1.3, 1.31, 1.34, 1.34, 1.37, 1.36, 1.39, 1.42, 1.41, 1.44, 1.45, 1.47, 1.48], plan: [1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2] },
              chips: ["Can we fund the JV from cash?", "Show the covenant headroom", "Project rate relief"],
              movers: {
                lifting: [
                  { name: "NUPCO collections", delta: "+SAR 145M awarded", contribution: 34, gm: null },
                  { name: "DPO discipline", delta: "+4 days", contribution: 12, gm: null }
                ],
                dragging: [{ name: "Inventory build", delta: "GLP-1 pre-stock", contribution: -8, gm: null }]
              }
          }
        ],
        findings: [
          ...
          { title: "SAR 8.6M is recoverable across the group", tag: "Cross-BU finding", detail: "Tamween audit (SAR 1.2M), duplicate-vendor spend, and aged AR concentrate the opportunity. The system has drafted the recovery sequence.", tone: "flat" },
          { title: "Operational resilience intact — cold-chain at a record", tag: "Group KPI · Resilience · run by Logistics", detail: "Cold-chain integrity reached 99.4%, the best on record, through the summer peak. No excursions in the last 30 days.", tone: "up" }
        ],
        developments: [
          { title: "Cold-chain hit a record 99.4% — best ever", meta: "Pharma Logistics · 2h ago", impact: "Reinforces the Resilience KPI and de-risks the NUPCO ramp. No plan change — protect the practice.", kind: "win" },
          { title: "NUPCO Q1 awards confirmed: +SAR 145M annual", meta: "Capital · 5h ago", impact: "Lifts the full-year revenue bridge by ~SAR 145M and improves cash timing. Plan revised upward next cycle.", kind: "win" },
          { title: "Tamween audit: SAR 1.2M recoverable", meta: "Tamween Distribution · yesterday", impact: "Folds into the SAR 8.6M group recovery. Net margin uplift ~10 bps once collected.", kind: "watch" }
        ],
        week: [
          { key: "board_prep", day: "Thu", title: "Board meeting", when: "in 3 days", prep: "Two decisions open: the FX hedge and the GLP-1 JV. The pack is 80% composed — margin narrative needs your line.", urgent: true, prompt: "Am I on track for the board on Thursday?" },
          { key: "jv", day: "Wed", title: "GLP-1 JV signature", when: "in 2 days", prep: "Supply-lock terms agreed; cash headroom confirmed. e-Pharmacy demand model attached.", urgent: true, prompt: "Can we fund the JV from cash?" },
          ...
          { key: "regulator", day: "next Fri", title: "Regulator meeting", when: "in 1 week", prep: "Routine cold-chain review — the 99.4% record is your opening.", urgent: false, prompt: "What should I emphasise in the regulator meeting?" }
        ]
      },
      cfo: {
        health: {
      ...
      gm: {
        ...
        drivers: [
          { key: "urev", label: "Unit revenue", pct: 112, value: "SAR 214M", sub: "quarter to date", vsPlan: "+12% vs plan", story: "112% of plan — the refill cohort is compounding. Riyadh and the app channel lead; cold-chain regions lag on capacity.", trendLabel: "Weekly revenue · 13 weeks", unit: "SAR M per week", chips: ["Where is capacity binding?", "Channel breakdown", "Refill cohort curve"], movers: { lifting: [{ name: "Riyadh region", delta: "+18% orders", contribution: 30 }, { name: "App channel", delta: "+22% conversion", contribution: 22 }], dragging: [{ name: "Eastern region", delta: "capacity-capped", contribution: -10 }] } },
      ...
      bucfo: {
        ...
        drivers: [
          ...
          { key: "dcost", label: "Operating cost", pct: 102, value: "SAR 47M", sub: "quarter to date", vsPlan: "+2% vs plan", story: "Slightly hot on cutover dual-running. Cost falls below plan once the S/4HANA cutover completes and legacy is retired.", trendLabel: "Weekly operating cost · 13 weeks", unit: "SAR M per week", chips: ["Cutover savings curve", "Legacy retirement date", "Cost by function"], movers: { lifting: [{ name: "Route optimisation", delta: "−1.5%", contribution: 10 }], dragging: [{ name: "Cutover dual-run", delta: "+SAR 0.9M", contribution: -16 }] } }
        ],
        owedUpward: {
    ...
    graph: {
      ...
      nodes: [
        { id: "plan", label: "Board plan v4", x: 50, y: 50, r: 13, category: "plan",
          detail: "The latest approved board strategy — every KPI, business unit plan, and contract traces back here.",
          hermes_prompt: "Summarize the current board plan and its key targets." },
        { id: "ebitda", label: "EBITDA margin", x: 50, y: 24, r: 11, category: "KPI",
          detail: "Your margin story — FX, input costs, and manufacturing all converge here. The single most-watched number in the board pack.",
          hermes_prompt: "Explain the EBITDA margin drivers and what's pulling it below plan." },
        { id: "cash", label: "Cash vs floor", x: 74, y: 32, r: 11, category: "KPI",
          detail: "Liquidity headroom against the board-mandated floor. Every contract and receivable affects this line.",
          hermes_prompt: "What's our cash position versus the board floor, and what's the nearest risk?" },
        { id: "fx", label: "FX exposure", x: 30, y: 12, r: 8, category: "KPI",
          detail: "Currency risk across SAR, USD, and EUR positions — a primary swing factor on margin.",
          hermes_prompt: "Explain our current FX exposure and how it impacts EBITDA margin." },
        { id: "api", label: "API input cost", x: 44, y: 8, r: 8, category: "KPI",
          detail: "Active pharmaceutical ingredient costs — the raw material line driving manufacturing input pricing.",
          hermes_prompt: "How are API input costs trending and what does that mean for manufacturing margins?" },
        { id: "mfg", label: "Manufacturing", x: 22, y: 30, r: 9, category: "business_unit",
          detail: "Manufacturing operations — where API costs, FX exposure, and production efficiency meet.",
          hermes_prompt: "Give me a status update on Manufacturing operations and their margin contribution." },
        { id: "dist", label: "Tamween Distribution", x: 30, y: 46, r: 9, category: "business_unit",
          detail: "Tamween's distribution network — the logistics backbone connecting manufacturing to retail and institutional accounts.",
          hermes_prompt: "How is Tamween Distribution performing and what are the key operational metrics?" },
        { id: "epharm", label: "e-Pharmacy", x: 70, y: 60, r: 9, category: "business_unit",
          detail: "Digital pharmacy channel — fastest-growing unit, tied to the GLP-1 JV strategy and retail expansion.",
          hermes_prompt: "What's the e-Pharmacy growth trajectory and how does it connect to the GLP-1 JV?" },
        { id: "leak", label: "Leakage finding", x: 18, y: 60, r: 8, category: "finding",
          detail: "SAR 8.6M in identified revenue leakage across institutional accounts — the single largest recovery opportunity.",
          hermes_prompt: "Explain the leakage finding — what was identified, how much is recoverable, and what's the timeline?" },
        { id: "tamween", label: "Tamween audit", x: 12, y: 46, r: 7, category: "document",
          detail: "Tamween's latest audit report — supporting documentation for the leakage finding and distribution review.",
          hermes_prompt: "What does the Tamween audit say about distribution performance and leakage?" },
        { id: "vendorx", label: "Vendor X", x: 10, y: 72, r: 7, category: "vendor",
          detail: "Key third-party vendor connected to the leakage investigation — procurement and contract compliance under review.",
          hermes_prompt: "What's the status of Vendor X in relation to the leakage investigation?" },
        { id: "ar_a", label: "Institutional A · AR", x: 26, y: 76, r: 7, category: "invoice",
          detail: "Accounts receivable from Institutional A — one of two major outstanding invoices tied to the leakage recovery.",
          hermes_prompt: "What's the status of Institutional A's accounts receivable and collection timeline?" },
        { id: "ar_b", label: "Institutional B · AR", x: 40, y: 80, r: 7, category: "invoice",
          detail: "Accounts receivable from Institutional B — the second major institutional invoice in the leakage recovery sequence.",
          hermes_prompt: "What's the collection status for Institutional B and are there any blockers?" },
        { id: "nupco", label: "NUPCO contract", x: 86, y: 48, r: 8, category: "contract",
          detail: "NUPCO supply agreement — a major government contract affecting cash flow, distribution, and board planning.",
          hermes_prompt: "Summarize the NUPCO contract terms, current status, and its impact on cash flow." },
        { id: "jv", label: "GLP-1 JV", x: 84, y: 70, r: 8, category: "contract",
          detail: "GLP-1 joint venture — the strategic growth play linking e-Pharmacy, NUPCO distribution, and cash allocation.",
          hermes_prompt: "What's the GLP-1 JV structure, funding requirement, and timeline to revenue?" },
        { id: "cust", label: "Pharmacy Retail", x: 60, y: 78, r: 8, category: "business_unit",
          detail: "Physical pharmacy retail network — consumer-facing channel complementing e-Pharmacy and driving prescription volume.",
          hermes_prompt: "How is Pharmacy Retail performing and what's the channel overlap with e-Pharmacy?" }
      ],
      edges: [
