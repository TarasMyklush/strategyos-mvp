...
trusted_proxy_auth_secret="$(generate_secret)"
...
replace_value "${SECRETS_FILE}" "STRATEGYOS_TRUSTED_PROXY_AUTH_SECRET" "${trusted_proxy_auth_secret}"
replace_value "${SECRETS_FILE}" "OAUTH2_PROXY_CLIENT_SECRET" "${oauth2_proxy_client_secret}"
replace_value "${SECRETS_FILE}" "OAUTH2_PROXY_COOKIE_SECRET" "${oauth2_proxy_cookie_secret}"
