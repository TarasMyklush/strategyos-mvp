...
def main() -> int:
    ...
    try:
        ...
        expect(assistant_text.locator('.assistant-message--assistant').last.locator('.assistant-tier')).to_have_text('Verified KPI context')
        expect(assistant_text).to_contain_text('The language answer could not be completed.')
